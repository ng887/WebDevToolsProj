...
const TodayWeather = ({
    ...
    return (
       <div className='card text-center' key='currentWeather'>
	                ...
	                <span>&nbsp;    {parseInt(todayWeather.main.temp - 273.15)}˚C</span>  <br/>
	             	<span><b>Wind Direction: </b>{todayWeather.wind.deg}  degree</span>
